...
if [ $? -eq 0 ]; then
    ...
    if [ -f "/home/andrem/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/andrem/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/andrem/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
if [ -f /home/andrem/.config/synth-shell/synth-shell-prompt.sh ] && [ -n "$( echo $- | grep i )" ]; then
	source /home/andrem/.config/synth-shell/synth-shell-prompt.sh
fi

##-----------------------------------------------------
## better-history
if [ -f /home/andrem/.config/synth-shell/better-history.sh ] && [ -n "$( echo $- | grep i )" ]; then
	source /home/andrem/.config/synth-shell/better-history.sh
fi
